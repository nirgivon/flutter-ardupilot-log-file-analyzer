...
class _LineChart extends StatelessWidget {
  const _LineChart(this.dataModel, {required this.isShowingMainData});
  ...
  List<FlSpot> getListofpoints() {
    List<FlSpot> points = [];

    if (dataModel.sensors.isNotEmpty) {
      DataSet data = dataModel.sensors[13].dataSet[0];
      int max = data.time.length;

      for (int i = 0; i < max; i++) {
        points.add(FlSpot(data.time[i], data.dataPoints[0][i]));
      }
    }
...
class LineChartSample1 extends StatefulWidget {
  const LineChartSample1(this.dataModel, {super.key});
            ...
            children: <Widget>[
              ...
              Expanded(
                child: Padding(
                  ...
                  child: _LineChart(widget.dataModel,
